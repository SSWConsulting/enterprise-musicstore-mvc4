...
namespace Northwind.MusicStore.WebUI.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        private readonly IWebSecurityProvider _webSecurityProvider;
        ...
        public ActionResult Login(LoginViewModel viewModel, string returnUrl)
        {
            if (ModelState.IsValid && WebSecurity.Login(viewModel.UserName, viewModel.Password, persistCookie: viewModel.RememberMe))
            {
                ...
                MigrateShoppingCart(viewModel.UserName);
        ...
        public ActionResult Register(RegisterModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                try
                {
                    _webSecurityProvider.CreateUserAndAccount(model.UserName, model.Password);
                    _webSecurityProvider.Login(model.UserName, model.Password);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Manage(LocalPasswordViewModel viewModel)
        {
            bool hasLocalAccount = OAuthWebSecurity.HasLocalAccount(WebSecurity.GetUserId(User.Identity.Name));
