...
namespace Northwind.MusicStore.Data.EntityConfig
{
    ...
    public class MusicStoreDbInitializer : CreateDatabaseIfNotExists<MusicStoreDbContext>//CreateDatabaseIfNotExists, DropCreateDatabaseIfModelChanges, AlwaysRecreateDatabase
    {
        public void MigrationsSeed(MusicStoreDbContext context)
        {
        ...
        protected override void Seed(MusicStoreDbContext context)
        {
            ...
            new List<Album>
            {
                ...
                new Album { Title = "Wagner: Favorite Overtures", Genre = genres.Single(g => g.Name == "Classical"), Price = 8.99M, Artist = artists.Single(a => a.Name == "Sir Georg Solti & Wiener Philharmoniker"), AlbumArtUrl = "/Content/Images/placeholder.gif" },
